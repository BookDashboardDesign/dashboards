...
# NEU: Density heatmap (2 Spalten umspannend) als 3. Plot auf Tab 2 mit Farb- und Auflösungs-Optionen
# NEU: Alles mit Inline-Style und Bootstrap (kein CSS)
...
if __name__ == '__main__':
    app.run_server(debug=True, port=8018)
